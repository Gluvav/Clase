...
public class HostReceptorGrupMulticastSocket {
	...
	public static void main(String[] args) throws UnknownHostException {
		// IDENTIFICADOR DE CLIENT GENERAT ALEAT�RIAMENT
		...
		InetSocketAddress grup = new InetSocketAddress(adresa, PORT);
		...
		try (MulticastSocket clientSocket = new MulticastSocket(PORT)) {
			...
			System.out.println("Host receptor s'ha unit al grup " + adresa);

			System.out.println("Inici recepci� paquets");
			while (true) {
